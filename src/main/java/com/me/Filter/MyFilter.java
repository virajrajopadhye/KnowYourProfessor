...
public class MyFilter implements Filter {
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("MyFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("MyFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("MyFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("MyFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
		...
		value = value.replaceAll("(?i)<.*?\\s+on.*?>.*?</.*?>", "");
               ...
               // value = value.replaceAll("*", "");
                value = value.replaceAll("1=1", "1_1");
                value = value.replaceAll("--", "");
                value = value.replaceAll("'", "''");
